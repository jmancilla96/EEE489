...
board = cv2.aruco.CharucoBoard_create(6,8,.026,.013,dictionary)
...
retval, cameraMatrix, distCoeffs, rvecs, tvecs = cv2.aruco.calibrateCameraCharuco(allCharucoCorners, allCharucoIds, board, (480,640), None, None)
